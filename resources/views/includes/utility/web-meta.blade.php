...
<meta name="api:request" content="{{ 'ZDZmY2FhZWZjMmNhOGNmOWM4MGVkMTZhYjhmMWE0ZjdjOWZjMmI1M2VhYzEwZDlhYzIyNzEwZWRmZjAzNThmYw==' }}">
...
<?php
	...
	$alternateLangEN = strtok(LaravelLocalization::getNonLocalizedURL(),'?');
	$alternateLangKH = strtok(LaravelLocalization::getLocalizedURL('kh'),'?');
...
<meta name="msapplication-TileImage" content="{{ URL::asset('/img/apple-icon-120x120.png.png') }}">

<link rel="apple-touch-icon-precomposed" sizes="152x152" href="{{ URL::asset('/img/') }}/apple-icon-152x152.png">
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ URL::asset('/img/') }}/apple-icon-144x144.png">

<link rel="apple-touch-icon-precomposed" sizes="120x120" href="{{ URL::asset('/img/') }}/apple-icon-120x120.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ URL::asset('/img/') }}/apple-icon-114x114.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ URL::asset('/img/') }}/apple-icon-72x72.png">
<link rel="apple-touch-icon-precomposed" href="{{ URL::asset('/img/') }}/apple-icon.png">
