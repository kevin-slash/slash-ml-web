...
<body style="    background-color: #E8E7E6;font-family: sans-serif;">	
    ...
    margin-bottom: 20px;">
	    	<img class="logo revel_animate" src="http://yellowlg.demo.flexitech.io/img/yellow-sea-logo-white.png" alt="biz-dimension logo" data-sr-id="2" style="; visibility: visible;  -webkit-transform: translateY(0) scale(1); opacity: 1;transform: translateY(0) scale(1); opacity: 1;-webkit-transition: -webkit-transform 1s cubic-bezier( 0.6, 0.2, 0.1, 1 ) 0s, opacity 1s cubic-bezier( 0.6, 0.2, 0.1, 1 ) 0s; transition: transform 1s cubic-bezier( 0.6, 0.2, 0.1, 1 ) 0s, opacity 1s cubic-bezier( 0.6, 0.2, 0.1, 1 ) 0s;  width: 200px">
	    </div>
